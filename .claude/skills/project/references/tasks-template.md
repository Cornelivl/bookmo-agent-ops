...
## Behavior Contract
### Current Behavior
<!-- What the system does today, including known pain points, stale tests, or inconsistent outcomes. Cite concrete evidence when possible. -->
- 

### Desired Behavior
<!-- The behavior that should exist after the work lands. Include invariants, state transitions, side effects, and user-visible guarantees. -->
- 

### Out of Contract
<!-- Behaviors intentionally deferred or explicitly not changing in this project. -->
- 
...
<!-- Short end-to-end flow for the ideal outcome. Call out jobs, emails, status transitions, or external systems inline. -->
1. 
2. 
3. 

## Impacted Areas
<!-- Exact files, packages, routes, jobs, schemas, docs, dashboards, or integrations that are in scope. -->
- 
...
## Review Pass
### Reviewer Checklist
<!-- Risks, edge cases, sequencing failures, weak ownership boundaries, rollout hazards, or missing verification that must be challenged before execution. -->
- 

### Findings Folded In
<!-- Summarize the durable conclusions from the skeptical review pass after you incorporate them. -->
- Pending.
