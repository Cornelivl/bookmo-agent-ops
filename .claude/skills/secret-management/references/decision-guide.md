...
- Add a machine-secret mapping under `~/Projects/scripts/sync/machine-secrets/*.env.map`.
...
Canonical docs:
- `/Users/cornelis/Projects/scripts/docs/architecture/secret-source-of-truth-flow.md`
- `/Users/cornelis/Projects/scripts/docs/references/azure-key-vault-structure.md`
...
Typical files:
- `/Users/cornelis/Projects/scripts/sync/machine-secrets/<integration>.env.map`
- `/Users/cornelis/Projects/scripts/sync/keyvault-sync-machine-secrets.sh`
- `/Users/cornelis/Projects/scripts/setup/codex/zshrc.shared`
